...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function jo(){return new Fi({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:No(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Mo(){return new Fi({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:No(),fragmentShader:`
	...
	`}var Po=class extends Jt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new yi(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}};uu.BlurDirectionX=new K(1,0),uu.BlurDirectionY=new K(0,1);var du=657156;function fu(e,{shadowMapSize:t=2048}={}){e.fog=new Fn(du,28,85);let n=new la(16773328,du,.35);e.add(n);let r=new Ea(16767130,.75);return r.position.set(32,42,22),r.castShadow=!0,r.shadow.mapSize.set(t,t),r.shadow.camera.near=10,r.shadow.camera.far=120,r.shadow.camera.left=-60,r.shadow.camera.right=60,r.shadow.camera.top=60,r.shadow.camera.bottom=-60,e.add(r),{hemi:n,sun:r}}function pu(e,t,n,r,i){let a=new su(e);a.addPass(new cu(t,n));let o=new uu(new K(r,i),1.15,.95,.72);return a.addPass(o),a}function mu(e,t,n){e.setSize(t,n)}function hu(e){let t=new $r(new Ti(180,180),new Ri({color:2038292}));t.rotation.x=-Math.PI/2,t.receiveShadow=!0,e.add(t);let n=new $r(new Ti(50,94),new Ri({color:1453334}));n.rotation.x=-Math.PI/2,n.position.y=.04,n.receiveShadow=!0,e.add(n);let r=new Ri({color:14540253});for(let[t,n,i]of[[0,0,46],[0,0,-46],[24,0,0],[-24,0,0],[0,0,23],[0,0,-23],[0,0,0]]){let n=new $r(new Ti(t===0?46:1.4,i===0?1.4:92),r);n.rotation.x=-Math.PI/2,n.position.set(t,.05,i),e.add(n)}}function gu(e){_u(e,-28,42),_u(e,28,42)}function _u(e,t,n){let r=new $r(new wi(.38,.48,24,6),new Ri({color:2763306}));r.position.set(t,12,n),r.castShadow=!0,e.add(r);let i=new Ca(16774344,3.2,95);i.position.set(t,25,n),e.add(i);let a=new $r(new Ei(.9,8,8),new Ri({color:16774344,emissive:6706466}));a.position.set(t,25,n),e.add(a)}function vu(e){let t=yu(3820090);t.position.set(-9,0,-28),t.rotation.y=.65,e.add(t)}function yu(e=12868654){let t=new Dn,n=new $r(new Ci(4.6,1.6,9.6),new Ri({color:e}));n.position.y=1.4,n.castShadow=!0,t.add(n);let r=new $r(new Ci(3.9,1.1,4.8),new Ri({color:3090210}));r.position.set(0,2.75,-1),r.castShadow=!0,t.add(r);let i=new $r(new Ci(3.5,.9,4.4),new Ri({color:1118481}));return i.position.set(0,2.85,-1),t.add(i),t}function bu(e){let t=new Dn;e.add(t);let n=new q(-19,2,14),r=new Ca(16755268,3.8,38);r.position.copy(n),e.add(r);let i=new Ar,a=new Float32Array(540),o=new Float32Array(540),s=new Float32Array(180),c=new Float32Array(540);for(let e=0;e<180;e++){let t=e*3;a[t]=(Math.random()-.5)*2.8,a[t+1]=Math.random()*4.5,a[t+2]=(Math.random()-.5)*2.8,c[t]=(Math.random()-.5)*.8,c[t+1]=1.8+Math.random()*1.6,c[t+2]=(Math.random()-.5)*.8;let n=Math.random();o[t]=1,o[t+1]=.35+n*.45,o[t+2]=.05,s[e]=.6+Math.random()*1.1}i.setAttribute(`position`,new hr(a,3)),i.setAttribute(`color`,new hr(o,3)),i.setAttribute(`size`,new hr(s,1));let l=new _i(i,new fi({size:1,vertexColors:!0,transparent:!0,opacity:.92,depthWrite:!1,blending:2,sizeAttenuation:!0}));l.position.copy(n),t.add(l);let u=new Ar,d=new Float32Array(195),f=new Float32Array(195),p=new Float32Array(65);for(let e=0;e<65;e++){let t=e*3;d[t]=(Math.random()-.5)*3.2,d[t+1]=Math.random()*5.5+.5,d[t+2]=(Math.random()-.5)*3.2,f[t]=(Math.random()-.5)*1.2,f[t+1]=2.4+Math.random()*2,f[t+2]=(Math.random()-.5)*1.2,p[e]=.35+Math.random()*.55}u.setAttribute(`position`,new hr(d,3)),u.setAttribute(`size`,new hr(p,1));let m=new _i(u,new fi({size:.9,color:16755251,transparent:!0,opacity:.85,depthWrite:!1,blending:2,sizeAttenuation:!0}));return m.position.copy(n),t.add(m),{update(e,t){r.intensity=3.1+(Math.sin(e*18)*.42+Math.random()*.28)*1.6,xu(l.geometry.attributes.position,c,180,t,7.5,2.8,1.2),xu(m.geometry.attributes.position,f,65,t*.85,9.5,3.2,1.5)}}}function xu(e,t,n,r,i,a,o){let s=e.array;for(let e=0;e<n;e++){let n=e*3;s[n+1]+=t[n+1]*r,s[n]+=t[n]*r,s[n+2]+=t[n+2]*r,s[n+1]>i&&(s[n]=(Math.random()-.5)*a,s[n+1]=.2+Math.random()*o,s[n+2]=(Math.random()-.5)*a)}e.needsUpdate=!0}var Su=`modulepreload`,Cu=function(e){return`/`+e},wu={},Tu=function(e,t,n){let r=Promise.resolve();if(t&&t.length>0){let e=document.getElementsByTagName(`link`),i=document.querySelector(`meta[property=csp-nonce]`),a=i?.nonce||i?.getAttribute(`nonce`);function o(e){return Promise.all(e.map(e=>Promise.resolve(e).then(e=>({status:`fulfilled`,value:e}),e=>({status:`rejected`,reason:e}))))}r=o(t.map(t=>{if(t=Cu(t,n),t in wu)return;wu[t]=!0;let r=t.endsWith(`.css`),i=r?`[rel="stylesheet"]`:``;if(n)for(let n=e.length-1;n>=0;n--){let i=e[n];if(i.href===t&&(!r||i.rel===`stylesheet`))return}else if(document.querySelector(`link[href="${t}"]${i}`))return;let o=document.createElement(`link`);if(o.rel=r?`stylesheet`:Su,r||(o.as=`script`),o.crossOrigin=``,o.href=t,a&&o.setAttribute(`nonce`,a),document.head.appendChild(o),r)return new Promise((e,n)=>{o.addEventListener(`load`,e),o.addEventListener(`error`,()=>n(Error(`Unable to preload CSS for ${t}`)))})}))}function i(e){let t=new Event(`vite:preloadError`,{cancelable:!0});if(t.payload=e,window.dispatchEvent(t),!t.defaultPrevented)throw e}return r.then(t=>{for(let e of t||[])e.status===`rejected`&&i(e.reason);return e().catch(i)})},Eu=6e4,Du=1.1,Ou=class{#e;#t;#n=null;#r=null;#i=[];#a=[];constructor(e,t){this.#e=e,this.#t=t}async init(){let{SparkRenderer:e,SplatMesh:t}=await Tu(async()=>{let{SparkRenderer:e,SplatMesh:t}=await import(`./spark.module-B33HYOyp.js`);return{SparkRenderer:e,SplatMesh:t}},[]);this.#r=t,this.#n=new e({renderer:this.#t}),this.#e.add(this.#n)}addSplat({url:e,position:t,scale:n=1,rotation:r={x:0,y:0,z:0},name:i=``,opacity:a=1,recolor:o,lod:s=!1,fadeIn:c=!1}){if(!this.#r)throw Error(`SplatManager.init() must be called before addSplat()`);let l=new this.#r({url:e,lod:s||void 0});return l.position.set(...t),l.scale.setScalar(n),l.rotation.set(r.x,r.y,r.z),l.name=i||e,o!==void 0&&l.recolor.set(o),c?(l.opacity=0,l.addEventListener(`load`,()=>{this.#a.push({mesh:l,target:a,speed:a/Du})})):l.opacity=a,this.#e.add(l),this.#i.push(l),l}update(e){this.#a.length!==0&&(this.#a=this.#a.filter(t=>{let n=t.mesh.opacity+t.speed*e;return n>=t.target?(t.mesh.opacity=t.target,!1):(t.mesh.opacity=n,!0)}))}loadAll(e,t){if(e.length===0)return t?.(0,0,null),Promise.resolve([]);let n=0,r=e.length;return Promise.all(e.map(e=>new Promise((i,a)=>{let o=this.addSplat(e),s=setTimeout(()=>{a(Error(`Timed out loading splat: ${e.name||e.url}`))},Eu);o.addEventListener(`load`,()=>{clearTimeout(s),n+=1,t?.(n,r,e.name),i(o)})})))}get splats(){return this.#i}},ku=`/assets/splats`,Au=[{name:`Tree — brown bark`,url:`${ku}/tree-brown-bark.spz`,position:[-20,-.15,-34],scale:1.5,rotation:{x:0,y:.4,z:0},fadeIn:!0},{name:`Tree — star canopy`,url:`${ku}/tree-star.spz`,position:[20,-.15,-32],scale:1.4,rotation:{x:0,y:-.6,z:0},fadeIn:!0},{name:`Tree — willow`,url:`${ku}/tree-willow.spz`,position:[-26,-.25,8],scale:1.3,rotation:{x:0,y:1.05,z:0},fadeIn:!0},{name:`Tree — brown bark (east)`,url:`${ku}/tree-brown-bark.spz`,position:[25,-.15,6],scale:1.35,rotation:{x:0,y:2.15,z:0},fadeIn:!0},{name:`Campfire`,url:`${ku}/campfire.spz`,position:[-19,.1,14],scale:.36,rotation:{x:0,y:-.25,z:0},opacity:.78,recolor:16750899,fadeIn:!0}],ju=[{name:`Classic car`,url:`${ku}/classic-car.spz`,position:[3.5,.05,10],scale:.52,rotation:{x:0,y:-.85,z:0},opacity:.92,recolor:13154456,fadeIn:!0},{name:`Hills backdrop`,url:`${ku}/hills-backdrop.spz`,position:[0,-4.5,-62],scale:2.9,rotation:{x:0,y:.12,z:0},opacity:.5,lod:!0,fadeIn:!0}];[...Au,...ju];var Mu=`dazed-loading-styles`,Nu=`The last night of summer · Texas, 1976`,Pu=`Drag to explore · Tap to focus · Pinch to zoom`,Fu=`
  #dazed-loading {
    position: fixed;
    inset: 0;
    z-index: 1000;
    ...
    text-align: center;
    background: radial-gradient(ellipse at center, #1a1208 0%, #0a0704 72%);
    color: #f5e6c8;
    font-family: Georgia, 'Times New Roman', serif;
    transition: opacity 0.8s ease, visibility 0.8s ease;
  }

  #dazed-loading.is-hidden {
    opacity: 0;
    visibility: hidden;
    pointer-events: none;
  }
  ...
  #dazed-loading .progress-fill {
    height: 100%;
    width: 0%;
    background: linear-gradient(90deg, #c45c2e, #ffd89a);
    border-radius: 2px;
    transition: width 0.35s ease;
  }

  #dazed-loading .progress-label {
    font-size: 0.72rem;
    opacity: 0.45;
    letter-spacing: 0.08em;
  }

  /* Title-phase elements start hidden and fade up when the scene is ready. */
  #dazed-loading .enter-group {
    display: flex;
    flex-direction: column;
    align-items: center;
    gap: 1rem;
  ...
  #dazed-loading .enter-group.is-visible {
    opacity: 1;
    transform: none;
    pointer-events: auto;
  }

  #dazed-loading .instructions {
    margin: 0;
  ...
  #dazed-loading .enter-btn {
    appearance: none;
    cursor: pointer;
    background: transparent;
    color: #ffd89a;
    border: 1px solid rgba(255, 216, 154, 0.45);
    border-radius: 2px;
  ...
  #dazed-loading .enter-btn:hover,
  #dazed-loading .enter-btn:focus-visible {
  ...
  #dazed-loading .sound-toggle:hover {
    opacity: 0.9;
  }

  #dazed-loading.is-error .message {
    color: #ff8866;
    opacity: 1;
  }
`;function Iu(){if(!document.getElementById(Mu)){let e=document.createElement(`style`);e.id=Mu,e.textContent=Fu,document.head.appendChild(e)}let e=document.createElement(`div`);e.id=`dazed-loading`;let t=document.createElement(`h1`);t.textContent=`Dazed & Confused`;let n=document.createElement(`p`);n.className=`tagline`,n.textContent=Nu;let r=document.createElement(`p`);r.className=`message`,r.textContent=`Loading scene…`;let i=document.createElement(`div`);i.className=`progress-track`;let a=document.createElement(`div`);a.className=`progress-fill`,i.appendChild(a);let o=document.createElement(`span`);o.className=`progress-label`,o.textContent=``;let s=document.createElement(`div`);s.className=`enter-group`;let c=document.createElement(`p`);c.className=`instructions`,c.textContent=Pu;let l=document.createElement(`button`);l.className=`enter-btn`,l.type=`button`,l.textContent=`Enter the night`;let u=!0,d=document.createElement(`button`);d.className=`sound-toggle`,d.type=`button`;let f=()=>{d.textContent=u?`♪ Ambient sound: On`:`♪ Ambient sound: Off`};return f(),d.addEventListener(`click`,()=>{u=!u,f()}),s.append(c,l,d),e.append(t,n,r,i,o,s),document.body.appendChild(e),{setMessage(e){r.textContent=e},setProgress(e,t,n){let r=t>0?e/t*100:0;a.style.width=`${r}%`,t>0&&n?o.textContent=`${e} / ${t} — ${n}`:t>0?o.textContent=`${e} / ${t} splats`:o.textContent=``},ready(){return r.style.display=`none`,i.style.display=`none`,o.style.display=`none`,s.classList.add(`is-visible`),new Promise(e=>{l.addEventListener(`click`,()=>e({sound:u}),{once:!0})})},hide(){e.classList.add(`is-hidden`),setTimeout(()=>e.remove(),850)},showError(t){e.classList.add(`is-error`),r.style.display=``,r.textContent=t,i.style.display=`none`,o.style.display=`none`,s.classList.remove(`is-visible`)}}}var Lu=`dazed-sound-btn-styles`,Ru=`
  #dazed-sound {
    position: fixed;
    right: 14px;
    bottom: 14px;
...
`;function zu(e){if(!document.getElementById(Lu)){let e=document.createElement(`style`);e.id=Lu,e.textContent=Ru,document.head.appendChild(e)}let t=document.createElement(`button`);t.id=`dazed-sound`,t.type=`button`;let n=()=>e.started&&!e.muted,r=()=>{let e=n();t.textContent=e?`♪`:`🔇`,t.setAttribute(`aria-label`,e?`Mute ambient sound`:`Enable ambient sound`)};return r(),t.addEventListener(`click`,()=>{n()?e.setMuted(!0):(e.started||e.start(),e.setMuted(!1)),r()}),document.body.appendChild(t),t}var Bu=e=>e<.5?4*e*e*e:1-(-2*e+2)**3/2;async function Vu(){let e=Iu();e.setMessage(`Setting up scene…`);try{let t=new In,n=new xa(62,innerWidth/innerHeight,.1,1e3);n.position.set(0,16,42);let r=matchMedia(`(pointer: coarse)`).matches,i=new vl({antialias:!0,alpha:!1,powerPreference:`high-performance`});i.setPixelRatio(Gl()),i.setSize(innerWidth,innerHeight),i.shadowMap.enabled=!0,i.shadowMap.type=2,i.shadowMap.autoUpdate=!1,document.body.appendChild(i.domElement),fu(t,{shadowMapSize:r?1024:2048});let a=pu(i,t,n,innerWidth,innerHeight);hu(t),gu(t),vu(t);let o=bu(t);i.shadowMap.needsUpdate=!0;let s=Kl(n,i.domElement);e.setMessage(`Gathering the night…`),e.setProgress(0,Au.length);let c=new Ou(t,i);await c.init(),await c.loadAll(Au,(t,n,r)=>{e.setProgress(t,n,r)});let l=new Ql(n,s,t,i.domElement);l.registerTarget({name:`Campfire`,position:[-19,2,14],focusDistance:15,hitRadius:5}),l.registerTarget({name:`Classic car`,position:[3.5,1.6,10],focusDistance:14,hitRadius:4.5}),l.registerTarget({name:`Willow`,position:[-26,4.5,8],focusDistance:22,hitRadius:5}),l.registerTarget({name:`Tree (east)`,position:[25,4.5,6],focusDistance:22,hitRadius:5}),l.setEnabled(!1),addEventListener(`resize`,()=>{n.aspect=innerWidth/innerHeight,n.updateProjectionMatrix(),i.setSize(innerWidth,innerHeight),mu(a,innerWidth,innerHeight)});let u=new q(0,23,62),d=n.position.clone(),f=0,p=!1,m=new Xa,h=0;function g(){requestAnimationFrame(g);let e=Math.min(m.getDelta(),.05);h+=e,p&&(f=Math.min(1,f+e/2.6),n.position.lerpVectors(u,d,Bu(f)),f>=1&&(p=!1,s.enabled=!0,l.setEnabled(!0))),o.update(h,e),c.update(e),l.update(e),s.update(),a.render()}g();let _=xl(),{sound:v}=await e.ready();try{v&&_.start(),zu(_),n.position.copy(u),s.enabled=!1,p=!0,e.hide(),c.loadAll(ju).catch(e=>{console.warn(`[Dazed & Confused] Deferred splats failed to load:`,e)})}catch(t){console.warn(`[Dazed & Confused] Reveal step failed (non-fatal):`,t),e.hide()}}catch(t){console.error(`[Dazed & Confused] Failed to start:`,t),e.showError(`Something went wrong loading the scene. Please reload.`)}}Vu();export{Li as A,Ie as B,d as C,J as D,Qa as E,kt as F,h as G,Gt as H,D as I,Kt as J,K,ne as L,En as M,wa as N,Qt as O,xa as P,j as R,c as S,ia as T,f as U,Fi as V,_ as W,Jt as X,Xt as Y,sa as _,Zn as a,ri as b,_a as c,Aa as d,Zt as f,ln as g,He as h,Po as i,a as j,$r as k,Xa as l,ni as m,To as n,hr as o,Yt as p,q,Z as r,Ar as s,ru as t,X as u,v,Le as w,Da as x,Ue as y,Ii as z};